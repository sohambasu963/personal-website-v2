...
export default function Home() {
  return (
    <div className='mt-12 flex flex-col items-center'>
      ...
      <div className="md:w-4/5 flex flex-col items-center mt-16 space-y-4" style={{ width: "90%" }}>
        <p
          className="md:text-lg text-md font-dm-sans text-off-black text-center tracking-tight"
        >
        ...
        <p
          className="md:text-lg text-md font-dm-sans text-off-black text-center tracking-tight"
        >
          Currently interning at Amazon as a Software Development Engineer in Vancouver!
        </p>
